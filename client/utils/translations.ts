...
export const translations = {
  ...
  // Login Modal
  namePlaceholder: { ta: 'உங்கள் பெயரை உள்ளிடவும்', en: 'Enter your name' },
  loginRegister: { ta: 'உள்நுழை', en: 'Login' },
  signup: { ta: 'பதிவு செய்', en: 'Register' },
  loginPrompt: { ta: 'தொடர உள்நுழையவும்', en: 'Join the community' },
  registerPrompt: { ta: 'புதிய கணக்கை உருவாக்கவும்', en: 'Create a new account' },
  ...
  hasAccount: { ta: 'ஏற்கனவே கணக்கு உள்ளதா?', en: "Already have an account?" },
  ...
  proverbs: { ta: 'பழமொழி', en: 'Proverbs' },
